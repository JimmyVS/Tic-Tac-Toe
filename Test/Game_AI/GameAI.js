...
// GameAI.js
// Global AI instance
let gameAI = new TicTacToeAI(); // Initialize immediately
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // The instance is already created, just log its status
    await gameAI.initializationPromise; // Wait for it to finish its internal async init
